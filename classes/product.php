...
<?php
    class product {
        ...
        public function getproduct_feathered_9(){
            $query = "SELECT * FROM tbl_sanpham ORDER BY rand() LIMIT 9";
            $result = $this->db->select($query);
            return $result;
        }
        ...
        public function timkiem(){
            ...
            $query = "SELECT * FROM tbl_sanpham WHERE sanpham_name LIKE '%$tukhoa%' OR sanpham_mota LIKE '%$tukhoa%'";
            $result = $this->db->select($query);
            return $result;
        }
    }
