                      ...
                      <div class="card-body py-5 px-md-5">
                        ...
                        <div class="information-wrapper">
                          <form action="" method="post">
                              ...
                              <input name="submit" class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" value="Đăng Ký" style="	border-radius: 10px;">
                              <!-- <input type="submit" class="a-thanhtoan btn btn-lg btn-primary btn-block text-uppercase" name="submit" value="Đăng kí"> -->
