		...
		<div class="row">
			<div class="col-xl-4 col-lg-3 col-md-12 order-lg-1 order-md-2 order-2">
				<div class="block-aside">
					...
					?>
						<a href="productbycat.php?catid=<?php echo $result_showCat['category_id'] ?>" class="
						<?php 
				...
				<div class="block-aside">
					...
					?>
						<a href="productbybrand.php?brandid=<?php echo $result_showBrand['brand_id'] ?>"><img src="./img/diamond.png"><span><?php echo $result_showBrand['brand_name'] ?></span></a>
					<?php }} ?>
					</div>
				</div>
				<div class="block-aside">
